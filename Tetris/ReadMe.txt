========================================================================
    Win32 アプリケーション: Tetris プロジェクトの概要
========================================================================

この Tetris アプリケーションは、AppWizard により作成されました。
...
Tetris.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル Tetris.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル Tetris.rc 
    にインクルードされます。
